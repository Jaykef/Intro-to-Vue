...
export default {
  data() {
    return {
      names: ['Charles, Shaheda', 'Imperial, Elaine', 'Benis, Hasnaa', 'Tapiwa, Taps', 'Jaykef, Jaward'],
      selected: '',
      prefix: '',
      first: '',
      last: ''
...
<template>
  <header>
    <img alt="My profile pic" class="logo" src="@/assets/jaykef.jpg" width="150" height="150" />
